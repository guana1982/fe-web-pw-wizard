export const externalUrlsPW = {
    ...
    BANCO_CESARE_PONTI_URL: 'https://homebanking.bpergroup.net/auth/#/auth?bank=03084',
    BLINK_BASE_PATH: 'https://intrawseal.gbbper.priv',
    HB_BPER_BASE_PATH: 'https://homebanking.bpergroup.net',
    AIUTO_CESARE_PONTI_URL: 'https://migrazioneib.bper.it/s/'
};
