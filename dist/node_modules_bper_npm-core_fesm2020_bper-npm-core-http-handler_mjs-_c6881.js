(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_bper_npm-core_fesm2020_bper-npm-core-http-handler_mjs-_c6881"],{
...
/***/ 82910:
/*!*****************************************************************************!*\
  !*** ./node_modules/@bper/npm-core/fesm2020/bper-npm-core-http-handler.mjs ***!
  \*****************************************************************************/
...
/* harmony export */   HttpApiInterface: () => (/* binding */ HttpApiInterface),
/* harmony export */   HttpHandlerModule: () => (/* binding */ HttpHandlerModule),
/* harmony export */   HttpHandlerService: () => (/* binding */ HttpHandlerService),
/* harmony export */   RequestPathParams: () => (/* binding */ RequestPathParams),
/* harmony export */   getHttpStoreId: () => (/* binding */ getHttpStoreId),
/* harmony export */   httpSortComparer: () => (/* binding */ httpSortComparer),
/* harmony export */   isStateValid: () => (/* binding */ isStateValid)
/* harmony export */ });
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs */ 23799);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs/operators */ 6143);
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 94744);
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngrx/store */ 18406);
/* harmony import */ var _ngrx_entity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/entity */ 79769);
...
function httpSortComparer(a, b) {
  if (a.lastUpdate > b.lastUpdate) return 1;
  if (a.lastUpdate < b.lastUpdate) return -1;
  return 0;
}
function getHttpStoreId({
  url,
  request = ''
}) {
  return `${url}::${request}`;
...
const ExecuteOrThrowErrorObservable$ = cb => {
  try {
    return cb();
  } catch (error) {
 ...
 */
class HttpApiService extends HttpApiInterface {
  constructor(_http) {
    super();
    this._http = _http;
  }
  get(url, extras, request) {
    let parsedPath;
    return ExecuteOrThrowErrorObservable$(() => {
      parsedPath = HttpApiService.parsePath(url, request?.pathParameters);
      const options = {
        params: this._setHttpParams(request?.bodyParameters),
        ...this._parseExtras(extras)
      };
      return this._http.get(parsedPath, options);
    });
  }
  post(url, extras, request) {
    let parsedPath;
    return ExecuteOrThrowErrorObservable$(() => {
      parsedPath = HttpApiService.parsePath(url, request?.pathParameters);
      const body = request?.bodyParameters || {};
      return this._http.post(parsedPath, body, {
        ...this._parseExtras(extras)
      });
    });
  }
  put(url, extras, request) {
    let parsedPath;
    return ExecuteOrThrowErrorObservable$(() => {
      parsedPath = HttpApiService.parsePath(url, request?.pathParameters);
      const body = request?.bodyParameters || {};
      return this._http.put(parsedPath, body, {
        ...this._parseExtras(extras)
      });
    });
  }
  delete(url, extras, request) {
    let parsedPath;
    return ExecuteOrThrowErrorObservable$(() => {
      parsedPath = HttpApiService.parsePath(url, request?.pathParameters);
      const options = {
      ...
      return this._http.delete(parsedPath, options);
    });
  }
  /**
   ...
   */
  static parsePath(url, pathParameters) {
...
HttpApiService.ɵfac = function HttpApiService_Factory(t) {
  return new (t || HttpApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient));
};
HttpApiService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: HttpApiService,
  factory: HttpApiService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HttpApiService, [{
...
const saveHttpCall = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createAction)('[HTTP Handler] Save API Call', (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.props)());
var http_actions = /*#__PURE__*/Object.freeze({
  __proto__: null,
  saveHttpCall: saveHttpCall
});
const HTTP_FEATURE_NAME = 'BPER::http-handler::api';
const httpStateAdapter = (0,_ngrx_entity__WEBPACK_IMPORTED_MODULE_3__.createEntityAdapter)({
  selectId: getHttpStoreId,
  sortComparer: httpSortComparer
});
const initialHttpState = httpStateAdapter.getInitialState();
const httpReducer = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createReducer)(initialHttpState, (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.on)(saveHttpCall, (state, action) => {
...
const {
  selectAll,
  selectEntities
} = httpStateAdapter.getSelectors();
const selectHttpState = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createFeatureSelector)(HTTP_FEATURE_NAME);
const selectHttps = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttpState, selectAll);
const selectHttpEntities = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttpState, selectEntities);
const validHttps = (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttps, https => https.map(http => isStateValid(http)));
const selectHttpResponse = (url, request) => (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttpEntities, https => {
  const id = getHttpStoreId({
    url,
    request
  });
...
const selectHttpPrevStatus = (url, request) => (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttpEntities, https => {
  const id = getHttpStoreId({
    url,
    request
  });
...
const selectHttpLastStatus = url => (0,_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.createSelector)(selectHttpEntities, https => {
  const httpKeys = Object.keys(https);
  const lastState = httpKeys.filter(key => key.indexOf(url) === 0).reduce((acc, curKey) => {
    if (acc?.lastUpdate && https[curKey].lastUpdate < acc?.lastUpdate) return acc;
    return https[curKey];
  }, {});
 ...
 * @extends {HttpApiInterface}
 */
class HttpMockService extends HttpApiInterface {
  constructor(_http) {
    super();
    this._http = _http;
  }
  get(url, extras, request = undefined) {
    const completeUrl = this._getCompleteUrl(url);
    return this._retrieveMock(completeUrl);
  }
  post(url, extras, request = undefined) {
    const completeUrl = this._getCompleteUrl(url);
    return this._retrieveMock(completeUrl);
  }
  put(url, extras, request = undefined) {
    const completeUrl = this._getCompleteUrl(url);
    return this._retrieveMock(completeUrl);
  }
  delete(url, extras, request = undefined) {
    const completeUrl = this._getCompleteUrl(url);
    return this._retrieveMock(completeUrl);
  }
  _getCompleteUrl(url) {
   ...
   */
  _retrieveMock(url) {
    return this._http.get(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.delay)(DELAY));
  }
}
HttpMockService.ɵfac = function HttpMockService_Factory(t) {
  return new (t || HttpMockService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient));
};
HttpMockService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: HttpMockService,
  factory: HttpMockService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HttpMockService, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Injectable
  }], function () {
    return [{
      type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient
...
class HttpHandlerService {
  constructor(_httpApiService, _httpMockService, _store) {
    this._httpApiService = _httpApiService;
    this._httpMockService = _httpMockService;
    this._store = _store;
  }
  retrieveDataFromApi(method, url, request, options) {
    const parsedUrl = HttpApiService.parsePath(url, request?.pathParameters);
    return this._makeAPICall(parsedUrl, method, request, options).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.take)(1));
  }
  retrieveData(method, url, request, options) {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.switchMap)(httpRes => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.iif)(() => !httpRes, this._makeAPICall(parsedUrl, method, request, options), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(httpRes))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.take)(1));
  }
  retrieveLatestState(url, request) {
    const parsedUrl = HttpApiService.parsePath(url, request?.pathParameters);
    // retrieve data from store
  ...
  retrievePreviousState(url, request) {
    const parsedUrl = HttpApiService.parsePath(url, request?.pathParameters);
    const requestObject = JSON.stringify(request?.bodyParameters);
    // retrieve data from store
  ...
  _makeAPICall(parsedUrl, method, request, options) {
    const opts = {
      ...defaultDataOptions,
      ...options
    };
    const extras = {
      ...defaultDataOptions.extras,
      ...(options?.extras || {})
    };
    const service = opts.mock ? this._httpMockService : this._httpApiService;
    return service[method](parsedUrl, extras, request).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.delay)(2000), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.retryWhen)(errors => errors.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.delay)(opts.delayRetries), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.concatMap)((e, index) => index + 1 === opts.retries ? (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)(e) : (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)(null)))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.tap)(res => this._store.dispatch(saveHttpCall({
      url: parsedUrl,
      request: JSON.stringify(request?.bodyParameters),
      response: JSON.stringify(res),
      expiresIn: opts.expiresIn
    }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.filter)(res => !!res));
  }
}
HttpHandlerService.ɵfac = function HttpHandlerService_Factory(t) {
  return new (t || HttpHandlerService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](HttpApiService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](HttpMockService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.Store));
};
HttpHandlerService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: HttpHandlerService,
  factory: HttpHandlerService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HttpHandlerService, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Injectable
  }], function () {
    return [{
      type: HttpApiService
...
const MULTIPLE_IMPORTS_ERROR = 'HttpHandlerModule is already loaded. Import it in the AppModule using the forRoot method';
class HttpHandlerModule {
  ...
  static forRoot() {
    return {
      ngModule: HttpHandlerModule,
      providers: [HttpApiService, HttpMockService, HttpHandlerService]
    };
  }
}
HttpHandlerModule.ɵfac = function HttpHandlerModule_Factory(t) {
  return new (t || HttpHandlerModule)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](HttpHandlerModule, 12));
};
HttpHandlerModule.ɵmod = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: HttpHandlerModule
});
HttpHandlerModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_ngrx_store__WEBPACK_IMPORTED_MODULE_2__.StoreModule.forFeature(HTTP_FEATURE_NAME, httpReducer)]
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HttpHandlerModule, [{
...
//# sourceMappingURL=node_modules_bper_npm-core_fesm2020_bper-npm-core-http-handler_mjs-_c6881.js.map