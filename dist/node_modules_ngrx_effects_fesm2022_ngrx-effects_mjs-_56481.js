(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_ngrx_effects_fesm2022_ngrx-effects_mjs-_56481"],{
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ 19923);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 99593);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! rxjs/operators */ 54899);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rxjs/operators */ 72607);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs/operators */ 81355);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs/operators */ 63076);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs/operators */ 17474);
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ 18406);
...
function mergeEffects(sourceInstance, globalErrorHandler, effectsErrorHandler) {
  ...
  const observables$ = getSourceMetadata(sourceInstance).map(({
    ...
    if (dispatch === false) {
      return effectAction$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.ignoreElements)());
    }
    const materialized$ = effectAction$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.materialize)());
    return materialized$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(notification => ({
  ...
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.merge)(...observables$);
}
const MAX_NUMBER_OF_RETRY_ATTEMPTS = 10;
function defaultEffectsErrorHandler(observable$, errorHandler, retryAttemptLeft = MAX_NUMBER_OF_RETRY_ATTEMPTS) {
  return observable$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(error => {
...
class Actions extends rxjs__WEBPACK_IMPORTED_MODULE_7__.Observable {
  constructor(source) {
    super();
    if (source) {
      this.source = source;
...
class EffectSources extends rxjs__WEBPACK_IMPORTED_MODULE_9__.Subject {
  ...
  toActions() {
    return this.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.groupBy)(effectsInstance => isClassInstance(effectsInstance) ? getSourceForInstance(effectsInstance) : effectsInstance), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.mergeMap)(source$ => {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(output => {
      ...
      const init$ = source$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.filter)(isOnInitEffects), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(instance => instance.ngrxOnInitEffects()));
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.merge)(effect$, init$);
    }));
  }
  /** @nocollapse */
...
configOrProject, errorFn) {
  ...
  return source => (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.defer)(() => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_5__.merge)(source.pipe(operator((input, index) => (0,rxjs__WEBPACK_IMPORTED_MODULE_16__.defer)(() => {
      let completed = false;
      let errored = false;
      let projectedCount = 0;
      return project(input, index).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.materialize)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(notification => {
...
function concatLatestFrom(observablesFactory) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.concatMap)(value => {
    const observables = observablesFactory(value);
    const observablesAsArray = Array.isArray(observables) ? observables : [observables];
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_18__.of)(value).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_19__.withLatestFrom)(...observablesAsArray));
  });
}
