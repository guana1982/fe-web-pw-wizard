(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-loader_mjs-_a7660"],{
...
/***/ 94258:
/*!*********************************************************************************!*\
  !*** ./node_modules/@bper/npm-core/fesm2020/bper-npm-core-utilities-loader.mjs ***!
  \*********************************************************************************/
...
function LoadingComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](4, "div", 4)(5, "span");
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵclassProp"]("fullPage", ctx_r0.fullPage);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](7, 3, ctx_r0.loaderService.loadingLabel));
  }
}
var ACTIONTYPE;
(function (ACTIONTYPE) {
...
class LoaderService {
  constructor() {
    ...
    this._selected$ = this._selected.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(v => !!v), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.shareReplay)());
    this.selected$ = this._selected$;
    this.isError$ = this._selected$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(value => this.isError(value)));
    this.isLoading$ = this._selected$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(value => this.isLoading(value)));
    this.label$ = this._selected$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(value => value.label || ''));
  }
  select(response) {
    this._selected.next(response);
  }
  success(label = '') {
    this.select({
  ...
  isLoading({
    ...
    return status === ACTIONTYPE.LOADING;
  }
  isError({
    status
  }) {
    return status === ACTIONTYPE.ERROR;
  }
  isSuccess({
    status
  }) {
    return status === ACTIONTYPE.SUCCESS;
  }
}
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoaderService, [{
...
class LoadingComponent {
  constructor(loaderService) {
    ...
    this.label = 'Loading...';
    /** Define the positioning absolute/fixed. If true (default value), a full page loader will be shown */
    this.fullPage = true;
  }
}
LoadingComponent.ɵfac = function LoadingComponent_Factory(t) {
  return new (t || LoadingComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](LoaderService));
};
LoadingComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
  type: LoadingComponent,
  selectors: [["swb-loader"]],
  inputs: {
    isLoading: "isLoading",
    label: "label",
    fullPage: "fullPage"
  ...
  decls: 2,
  vars: 3,
  consts: [[4, "ngIf"], [1, "loader"], ["viewBox", "0 0 50 50", 1, "spinner"], ["cx", "25", "cy", "25", "r", "20", "fill", "none", "stroke-width", "4", 1, "path"], [1, "loaderLabel"], [1, "overview"]],
  template: function LoadingComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](0, LoadingComponent_ng_container_0_Template, 9, 5, "ng-container", 0);
  ...
  dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_0__.NgIf, _angular_common__WEBPACK_IMPORTED_MODULE_0__.AsyncPipe],
  styles: [".loader.fullPage[_ngcontent-%COMP%]{position:fixed}.loader.fullPage[_ngcontent-%COMP%] + .overview[_ngcontent-%COMP%]{position:fixed}.overview[_ngcontent-%COMP%]{position:absolute;inset:0;background-color:#47474780;z-index:10003;pointer-events:none}.loader[_ngcontent-%COMP%]{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);margin:0 auto;text-align:center;z-index:10004}.loaderLabel[_ngcontent-%COMP%]{text-align:center;color:#004c8a}.spinner[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_rotate 2s linear infinite;z-index:2;position:absolute;top:50%;left:50%;margin:-25px 0 0 -50px;width:100px;height:100px}.spinner[_ngcontent-%COMP%]   .path[_ngcontent-%COMP%]{stroke:#73e6bc;stroke-linecap:round;animation:_ngcontent-%COMP%_dash 1.5s ease-out infinite}@keyframes _ngcontent-%COMP%_rotate{to{transform:rotate(360deg)}}@keyframes _ngcontent-%COMP%_dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}to{stroke-dasharray:90,150;stroke-dashoffset:-124}}"],
  changeDetection: 0
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoadingComponent, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_1__.Component,
    args: [{
      selector: 'swb-loader',
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__.ChangeDetectionStrategy.OnPush,
      template: "<ng-container *ngIf=\"loaderService.isLoading$ | async as isLoading\">\n    <div class=\"loader\" [class.fullPage]=\"fullPage\">\n        <svg class=\"spinner\" viewBox=\"0 0 50 50\">\n            <circle class=\"path\" cx=\"25\" cy=\"25\" r=\"20\" fill=\"none\" stroke-width=\"4\"></circle>\n        </svg>\n        <div class=\"loaderLabel\">\n            <span>{{ loaderService.loadingLabel | async }}</span>\n        </div>\n    </div>\n    <div class=\"overview\"></div>\n</ng-container>\n",
      styles: [".loader.fullPage{position:fixed}.loader.fullPage+.overview{position:fixed}.overview{position:absolute;inset:0;background-color:#47474780;z-index:10003;pointer-events:none}.loader{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);margin:0 auto;text-align:center;z-index:10004}.loaderLabel{text-align:center;color:#004c8a}.spinner{animation:rotate 2s linear infinite;z-index:2;position:absolute;top:50%;left:50%;margin:-25px 0 0 -50px;width:100px;height:100px}.spinner .path{stroke:#73e6bc;stroke-linecap:round;animation:dash 1.5s ease-out infinite}@keyframes rotate{to{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}to{stroke-dasharray:90,150;stroke-dashoffset:-124}}\n"]
    }]
  }], function () {
    return [{
      type: LoaderService
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoaderModule, [{
...
//# sourceMappingURL=node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-loader_mjs-_a7660.js.map