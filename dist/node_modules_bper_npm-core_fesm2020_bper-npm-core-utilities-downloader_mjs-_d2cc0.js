(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-downloader_mjs-_d2cc0"],{
...
/***/ 38160:
/*!*************************************************************************************!*\
  !*** ./node_modules/@bper/npm-core/fesm2020/bper-npm-core-utilities-downloader.mjs ***!
  \*************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DownloadResourcesService: () => (/* binding */ DownloadResourcesService),
/* harmony export */   SAFARI_DOWNLOAD_THRESHOLD_VERSION: () => (/* binding */ SAFARI_DOWNLOAD_THRESHOLD_VERSION),
/* harmony export */   downloadFromUrl: () => (/* binding */ downloadFromUrl),
/* harmony export */   getSafariMobileVersion: () => (/* binding */ getSafariMobileVersion),
/* harmony export */   isSafariMobile: () => (/* binding */ isSafariMobile),
/* harmony export */   setDownloadOnAnchor: () => (/* binding */ setDownloadOnAnchor)
/* harmony export */ });
/* harmony import */ var C_Users_daniele_regno_bper_fe_web_pw_wizard_14_16_gitHub_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
...
/* harmony import */ var _bper_npm_core_tealium_utag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @bper/npm-core/tealium-utag */ 84858);
 ...
 */
const downloadFromUrl = /*#__PURE__*/function () {
  var _ref = (0,C_Users_daniele_regno_bper_fe_web_pw_wizard_14_16_gitHub_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, filename = null, index = 0) {
    let newWindow;
    if (isSafariMobile()) {
    ...
    try {
      const blob = yield fetch(path).then(r => r?.blob());
  ...
  return function downloadFromUrl(_x) {
    return _ref.apply(this, arguments);
  };
}();
const setDownloadOnAnchor = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_daniele_regno_bper_fe_web_pw_wizard_14_16_gitHub_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, filename, anchor) {
    const anchorItem = anchor || document.createElement('a');
    try {
      const blob = yield fetch(path).then(r => r?.blob());
  ...
  return function setDownloadOnAnchor(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
/* SAFARI */
const SAFARI_DOWNLOAD_THRESHOLD_VERSION = 14;
const isSafariMobile = () => {
  const userAgent = navigator.userAgent && navigator.userAgent.toLowerCase();
  return navigator.vendor && navigator.vendor.indexOf('Apple') > -1 && userAgent && (userAgent.indexOf('ipad') > -1 || userAgent.indexOf('iphone') > -1) && userAgent.indexOf('safari') > -1 && userAgent.indexOf('crios') == -1 && userAgent.indexOf('fxios') == -1;
};
const getSafariMobileVersion = () => {
  return isSafariMobile() && navigator.userAgent?.match(new RegExp('version/([0-9]{2})', 'i'))?.[1];
};
class DownloadResourcesService {
  constructor(_tealium) {
    this._tealium = _tealium;
  }
  downloadPdfListFromService(service$, a) {
    return service$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(({
      pdfFileList = []
    }) => {
      let index = 0;
      for (let pdfFile of pdfFileList) {
        if (!(getSafariMobileVersion() >= SAFARI_DOWNLOAD_THRESHOLD_VERSION)) {
          this._tealium.link({
            event_action: 'click',
            event_category: 'download',
            event_label: 'pdf-' + pdfFile.fileName
          });
        }
        this.downloadResources(pdfFile.fileName, pdfFile.resourceData, 'PDF', index++, a);
      }
    }));
  }
  downloadResources(fileName, resourceData, resourceType = 'PDF', index = 0, a) {
    let hrefData;
    switch (resourceType) {
      case 'JPG':
      case 'JPEG':
        hrefData = 'data:application/jpeg;base64,' + resourceData;
        break;
      case 'PDF':
      ...
      case 'XLS':
        ...
        break;
      case 'XML':
        hrefData = 'data:application/xml;base64,' + resourceData;
        break;
      case 'ZIP':
    ...
    if (getSafariMobileVersion() >= SAFARI_DOWNLOAD_THRESHOLD_VERSION) {
      setDownloadOnAnchor(hrefData, fileName, a);
      a.onclick = () => {
        this._tealium.link({
          event_action: 'click',
          event_category: 'download',
      ...
      downloadFromUrl(hrefData, fileName, index);
    }
  }
  downloadFileFromService(service$, a, resourceType = 'PDF') {
    return service$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(file => {
      if (resourceType === 'auto') {
        resourceType = file.fileName?.split('.')?.pop()?.toUpperCase();
      }
      if (!(getSafariMobileVersion() >= SAFARI_DOWNLOAD_THRESHOLD_VERSION)) {
        this._tealium.link({
          event_action: 'click',
          event_category: 'download',
          event_label: resourceType.toLowerCase() + '-' + file.fileName
        });
      }
      this.downloadResources(file.fileName, file.resourceData, resourceType, 0, a);
    }));
  }
}
DownloadResourcesService.ɵfac = function DownloadResourcesService_Factory(t) {
  return new (t || DownloadResourcesService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_bper_npm_core_tealium_utag__WEBPACK_IMPORTED_MODULE_2__.TealiumUtagService));
};
DownloadResourcesService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
  token: DownloadResourcesService,
  factory: DownloadResourcesService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DownloadResourcesService, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injectable
  }], function () {
    return [{
      type: _bper_npm_core_tealium_utag__WEBPACK_IMPORTED_MODULE_2__.TealiumUtagService
    }];
  }, null);
})();
...
//# sourceMappingURL=node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-downloader_mjs-_d2cc0.js.map