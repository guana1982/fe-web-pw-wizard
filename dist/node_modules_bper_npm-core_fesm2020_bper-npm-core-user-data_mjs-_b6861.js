(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_bper_npm-core_fesm2020_bper-npm-core-user-data_mjs-_b6861"],{
...
/***/ 9578:
/*!**************************************************************************!*\
  !*** ./node_modules/@bper/npm-core/fesm2020/bper-npm-core-user-data.mjs ***!
  \**************************************************************************/
...
/* harmony export */   UserManagementEnum: () => (/* binding */ UserManagementEnum),
/* harmony export */   UserPermissionTypeEnum: () => (/* binding */ UserPermissionTypeEnum),
/* harmony export */   UserTypeEnum: () => (/* binding */ UserTypeEnum),
/* harmony export */   customerTypeCategoryEnum: () => (/* binding */ customerTypeCategoryEnum),
/* harmony export */   provenanceBankCodeType: () => (/* binding */ provenanceBankCodeType),
...
(function (DocumentStatus) {
  ...
  DocumentStatus["IN_VALIDAZIONE"] = "IN_VALIDAZIONE";
  DocumentStatus["ACCETTATO"] = "ACCETTATO";
  DocumentStatus["RIFIUTATO"] = "RIFIUTATO";
  DocumentStatus["IN_SCADENZA"] = "IN_SCADENZA";
  DocumentStatus["SCADUTO"] = "SCADUTO";
})(DocumentStatus || (DocumentStatus = {}));
var provenanceBankCodeType;
(function (provenanceBankCodeType) {
  provenanceBankCodeType["CRG"] = "CRG";
  provenanceBankCodeType["BML"] = "BML";
  provenanceBankCodeType["BCP"] = "BCP";
})(provenanceBankCodeType || (provenanceBankCodeType = {}));
var UserManagementEnum;
(function (UserManagementEnum) {
  UserManagementEnum["BUSINESS"] = "sb";
  UserManagementEnum["PRIVATO"] = "pf";
  UserManagementEnum["INFORMATIVO"] = "info";
})(UserManagementEnum || (UserManagementEnum = {}));
var customerTypeCategoryEnum;
(function (customerTypeCategoryEnum) {
  customerTypeCategoryEnum["INDIVIDUAL"] = "INDIVIDUAL";
  customerTypeCategoryEnum["LEGAL_ENTITY"] = "LEGAL_ENTITY";
  customerTypeCategoryEnum["UNKNOWN"] = "UNKNOWN";
})(customerTypeCategoryEnum || (customerTypeCategoryEnum = {}));
// PHONE BANKING
var UserPermissionTypeEnum;
(function (UserPermissionTypeEnum) {
  UserPermissionTypeEnum["DISPO"] = "DISPO";
  UserPermissionTypeEnum["INFO"] = "INFO";
})(UserPermissionTypeEnum || (UserPermissionTypeEnum = {}));
var UserTypeEnum;
(function (UserTypeEnum) {
  UserTypeEnum["PHONE_BANKING"] = "PHONE_BANKING";
  UserTypeEnum["REAL_CUSTOMER"] = "REAL_CUSTOMER";
  UserTypeEnum["SYNTHETIC_USER"] = "SYNTHETIC_USER";
})(UserTypeEnum || (UserTypeEnum = {}));
let apiEndPoint;
let externalUrls;
function resolveUrl(urlName) {
  const BASE_API_ROOT = `${apiEndPoint?.BFFE_USER_DATA || '/bffe-user-data'}/private/user`;
  const BASE_API_SECURITY = `${apiEndPoint?.BFFE_USER_SECURITY || '/bffe-user-security'}/private`;
  const DIGITAL_SIGNATURE_PATH = `${apiEndPoint?.BFFE_PRODUCTS}/private/digital-signature/v1`;
  const USER_DATA_ROUTES = {
    getUserData: `${BASE_API_ROOT}/v3/user`,
    getUserBranch: `${BASE_API_ROOT}/v1/branch`,
    getUserCluster: `${BASE_API_ROOT}/v1/cluster`,
    getLastAccesses: `${BASE_API_SECURITY}/v1/user/accesses`,
    certificateStatus: `${DIGITAL_SIGNATURE_PATH}/certificate-status`,
    refreshSession: `${BASE_API_SECURITY}/v1/session/refresh`,
    getStatusTutelato: `${apiEndPoint?.BFFE_PRODUCTS}/private/mifid/v1/is-tutelato`,
    postLogin: BASE_API_SECURITY + '/v2/login/complete',
    logout: `${BASE_API_SECURITY}/v1/logout`,
    logoutWS: '/pkmslogout',
    logoutWSNumera: externalUrls?.TRADING_ONLINE_LOGOUT_NUMERA,
    logoutTOL: externalUrls?.TRADING_ONLINE_LOGOUT,
    logoutTOLPB: externalUrls?.TRADING_ONLINE_LOGOUT_PHONE_BANKING,
    // PHONE BANKING
    pbLogin: `${apiEndPoint?.BFFE_PHONE_BANKING}/private/user/v1/submit-search`,
    searchCustomers: `${apiEndPoint?.BFFE_PHONE_BANKING}/private/user/v1/search-customers`,
    // OLD
    searchCustomer: `${BASE_API_ROOT}/v1/search-customers`,
    submitSearch: `${BASE_API_ROOT}/v1/submit-search`
  };
  return USER_DATA_ROUTES[urlName] || '';
}
class UserDataService {
  constructor(_httpHandler, _apiEndpoint, _externalUrls) {
    this._httpHandler = _httpHandler;
    this._userDataSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
    this._userBranchSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
    this._userClusterSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
    this._userAccessesSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
    this._certificateStatusSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
    this.userData$ = this._userDataSubject.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(res => !!res));
    this.userBranch$ = this._userBranchSubject.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(res => !!res));
    this.userAccesses$ = this._userAccessesSubject.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(res => !!res));
    this.userCluster$ = this._userClusterSubject.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => !this._userClusterInitialized && this._setUserClusterData()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(res => !!res));
    this.certificateStatus$ = this._certificateStatusSubject.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => !this._certificateStatusInitialized && this._setCertificateStatus()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(res => !!res));
    this._userClusterInitialized = false;
    this._certificateStatusInitialized = false;
    apiEndPoint = _apiEndpoint;
    externalUrls = _externalUrls;
  }
  get management() {
    switch (this.userData?.management?.toLowerCase()) {
      case 'sb':
        return UserManagementEnum.BUSINESS;
      case 'pf':
        return UserManagementEnum.PRIVATO;
      case 'info':
        return UserManagementEnum.INFORMATIVO;
    }
  }
  get isPersonaGiuridica() {
    return this.userData?.customerTypeCategory == customerTypeCategoryEnum.LEGAL_ENTITY;
  }
  updateUserData() {
    this._retrieveUserData().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe();
  }
  updateUserBranch() {
    this._setUserBranchData();
  }
  updateUserCluster() {
    this._setUserClusterData();
  }
  updateCertificateStatus() {
    this._setCertificateStatus();
  }
  get userData() {
    return this._userData || {};
  }
  get userCredential() {
    return this._userData?.credentialData || {};
  }
  get userAddress() {
    return {
      residence: this._userData?.residenceData || {},
      domicile: this._userData?.domicileData || {}
    };
  }
  get userDocumentInfo() {
    return this._userData?.documentInfo || {};
  }
  get isDocumentExpired() {
    return this.userDocumentInfo.documentStatus == DocumentStatus.SCADUTO;
  }
  get userConsents() {
    return this._userData?.consents || [];
  }
  get contactsData() {
    return this._userData?.contactsData || {};
  }
  get userProduct() {
    return this._userData?.product || {};
  }
  get userBranch() {
  ...
  // User Cluster
  get userCluster() {
    !this._userClusterInitialized && this._setUserClusterData();
    return this._userCluster || {};
  }
  get isUserClusterBlack() {
    return !this.userCluster?.clusterCode || this.userCluster.clusterCode === 'BLACK';
  }
  get isUserClusterGold() {
    return this.userCluster?.clusterCode === 'GOLD';
  }
  // Fine - User Cluster
  get userAccesses() {
  ...
  get certificateStatus() {
    !this._certificateStatusInitialized && this._setCertificateStatus();
    return this._certificateStatus || {};
  }
  get userIsSca() {
    return this._userData?.credentialData?.authenticationType === 'SCA';
  }
  get userProductsAvailability() {
    return this._userData?.productsAvailability || {};
  }
  get isFirstLogin() {
    return this._userData?.isFirstNPMLogin || false;
  }
  get grantAccessToMifid() {
    // condizione mostra mifid -> NOT PG AND ( NOT in (PV_1000001, PV_1000010))
    return !this.isPersonaGiuridica && !~['PV_1000001', 'PV_1000010'].indexOf(this.userProduct?.code);
  }
  isUserTutelato() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('getStatusTutelato'), null, {
  ...
  refreshSessionActivity() {
    const body = {};
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('refreshSession'), body, {
      expiresIn: 0
    });
  }
  _onLoginComplete() {
    ...
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('postLogin'), body, {
      expiresIn: 0
    });
  }
  _onLoginPB(customerId, bank) {
    const body = {
      bodyParameters: {
        customerId
      }
    };
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('pbLogin'), body, {
      expiresIn: 0
    });
  }
  // Recupera le informazioni di base dell'utente
  _retrieveUserData() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('getUserData')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userData => this._userData = userData), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userData => this._userDataSubject.next(userData)));
  }
  // Recupera le informazioni sulla filiale di appartenenza
  _setUserBranchData() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('getUserBranch'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userBranch => this._userBranch = userBranch), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userBranch => this._userBranchSubject.next(userBranch))).subscribe();
  }
  // Recupera le informazioni sul cluster dell'utente
  _setUserClusterData() {
    this._userClusterInitialized = true;
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('getUserCluster'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userCluster => this._userCluster = userCluster), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userCluster => this._userClusterSubject.next(userCluster)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(() => {
      this._userClusterInitialized = false;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(null);
    })).subscribe();
  }
  // Recupera le informazioni sugli ultimi accessi dell'utente
  _setUserAccesses() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('getLastAccesses'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userAccesses => this._userAccesses = userAccesses), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(userAccesses => this._userAccessesSubject.next(userAccesses))).subscribe();
  }
  // Recupera le informazioni sullo stato della Firma Digitale dell'utente
  _setCertificateStatus() {
    this._certificateStatusInitialized = true;
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('certificateStatus'), {}, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(certificateStatus => this._certificateStatus = certificateStatus), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(certificateStatus => this._certificateStatusSubject.next(certificateStatus)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(() => {
      this._certificateStatusInitialized = false;
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(null);
    })).subscribe();
  }
  logout(preventRedirect = false) {
    /** Utilizzo questa variabile per lanciare logout applicativi per cui non mi serve attendere risposta */
    const logoutWSs$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.combineLatest)([this._logoutTOL().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(err => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(true))), this._logoutWSNumera().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(err => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(true)))]);
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('logout')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(err => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(true)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(_ => logoutWSs$.subscribe()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.switchMap)(_ => this._logoutWS().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(err => (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(true)))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(_ => {
      if (!preventRedirect) {
        const url = this.isPhoneBanking ? externalUrls?.NPM_PHONE_BANKING : `${externalUrls?.NPM_PUBLIC_LOGOUT}?bank=${this.userData?.abi || ''}`;
        location.href = url;
      }
    }));
  }
  _logoutWS() {
    if (this.isPhoneBanking) return (0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(true);
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('logoutWS'));
  }
  // webseal numera per reset sessione trading online
  _logoutWSNumera() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('logoutWSNumera'));
  }
  _logoutTOL() {
    const inner = {
      H: 'mww',
    ...
    const body = {
      bodyParameters: JSON.stringify(outer)
    };
    if (this.isPhoneBanking) {
      return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('logoutTOLPB'), body);
    }
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('logoutTOL'), body);
  }
  // PHONE BANKING
  get hasDispositivePermissions() {
    return this.userData?.userPermissionType === UserPermissionTypeEnum.DISPO;
  }
  get isPhoneBanking() {
    return this.userData?.userType === UserTypeEnum.PHONE_BANKING;
  }
}
UserDataService.ɵfac = function UserDataService_Factory(t) {
  return new (t || UserDataService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HttpHandlerService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"]('API_ENDPOINT'), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"]('EXTERNAL_URLS'));
};
UserDataService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: UserDataService,
  factory: UserDataService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserDataService, [{
...
const MULTIPLE_IMPORTS_ERROR = 'UserDataModule is already loaded. Import it in the AppModule using the forRoot method';
...
UserDataModule.ɵfac = function UserDataModule_Factory(t) {
  return new (t || UserDataModule)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](UserDataModule, 12));
};
UserDataModule.ɵmod = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
  type: UserDataModule
});
UserDataModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserDataModule, [{
...
//# sourceMappingURL=node_modules_bper_npm-core_fesm2020_bper-npm-core-user-data_mjs-_b6861.js.map