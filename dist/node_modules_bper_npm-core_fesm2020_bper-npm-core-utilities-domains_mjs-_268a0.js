(self["webpackChunkfe_web_pw_wizard"] = self["webpackChunkfe_web_pw_wizard"] || []).push([["node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-domains_mjs-_268a0"],{
...
/***/ 95146:
/*!**********************************************************************************!*\
  !*** ./node_modules/@bper/npm-core/fesm2020/bper-npm-core-utilities-domains.mjs ***!
  \**********************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SEPA_NATIONS_EXTRA_UE: () => (/* binding */ SEPA_NATIONS_EXTRA_UE),
...
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! moment/moment */ 58540);
...
const SEPA_NATIONS_EXTRA_UE = ['MC', 'VA', 'AD', 'GB', 'IS', 'LI', 'NO', 'SM', 'CH'];
let apiEndPoint;
let externalUrls;
function resolveUrl(urlName) {
  const BASE_PATH = '/private/accounts/v1/';
  const BASE_API_ROOT = apiEndPoint.BFFE_PAYMENTS + BASE_PATH;
  const BASE_API_DOMAINS = apiEndPoint.BFFE_PRODUCTS + '/private/domain/v1';
  const BASE_API_PRODUCTS = apiEndPoint.BFFE_PRODUCTS + '/private/products/v1';
  const UTILITIES_ROUTES = {
    // Endpoint BFFE
    festivities: BASE_API_ROOT + 'transfers/festivities',
    // Endpoint Domains
    ISONations: BASE_API_DOMAINS + '/all-nations',
    nations: BASE_API_DOMAINS + '/nations',
    regions: BASE_API_DOMAINS + '/regions',
    provinces: BASE_API_DOMAINS + '/provinces',
    towns: BASE_API_DOMAINS + '/provinces/:provinceCode/towns',
    zipCode: BASE_API_DOMAINS + '/provinces/:provinceCode/towns/:townName/zip-code',
    zipCodes: BASE_API_DOMAINS + '/zip-codes',
    currencies: BASE_API_DOMAINS + '/currencies',
    contractType: BASE_API_DOMAINS + '/contract-type',
    familySituation: BASE_API_DOMAINS + '/family-situation',
    housingSituation: BASE_API_DOMAINS + '/housing-situation',
    onlinePurposes: BASE_API_DOMAINS + '/online-purposes',
    professionCode: BASE_API_DOMAINS + '/profession-code',
    docTypes: BASE_API_DOMAINS + '/doc-types',
    authorities: BASE_API_DOMAINS + '/:docType/authorities',
    authoritiesV2: apiEndPoint.BFFE_PRODUCTS + '/private/domain/v2' + '/:docType/authorities',
    continuosIncome: BASE_API_DOMAINS + '/continuos-income',
    continuosOutcome: BASE_API_DOMAINS + '/continuos-outcome',
    favourite: BASE_API_PRODUCTS + '/:productId/favourite',
    personalizedName: BASE_API_PRODUCTS + '/:productId/personalized-name',
    blockCardReasons: BASE_API_DOMAINS + '/card/block-reasons',
    proposalsNumber: BASE_API_DOMAINS + '/ofs/proposals-number',
    searchPeriod: BASE_API_DOMAINS + '/ofs/search-period'
  };
  return UTILITIES_ROUTES[urlName] || '';
}
/**
 *  Set of methods to retrieve static elements
 */
class UtilitiesService {
  constructor(_httpHandler, _apiEndpoint, _externalUrls) {
    this._httpHandler = _httpHandler;
    this._festivities$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    this._nations$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    this._ISONations$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    this._regions$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    this._provinces$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    this._currencies$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
    /** List of festivities */
    this.festivities$ = this._festivities$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of nations mapped by code */
    this.nations$ = this._nations$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of nations mapped by code */
    this.nationsList$ = this.nations$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(n => n.domain), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of ISO nations mapped by code */
    this.ISONations$ = this._ISONations$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of fees Payment Modes mapped by code */
    this.feesPaymentModesList$ = this.nations$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(n => n.feesPaymentModesDomain), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of regions mapped by code */
    this.regions$ = this._regions$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of provinces mapped by code */
    this.provinces$ = this._provinces$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    /** List of currencies mapped by code */
    this.currencies$ = this._currencies$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(r => !!r));
    apiEndPoint = _apiEndpoint;
    externalUrls = _externalUrls;
  }
  init() {
    this._setFestivities();
    this._setCurrencies();
    this._setNations();
    this._setISONations();
    this._setRegions();
  ...
  _setFestivities() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('festivities'), {}, {
      // mock: true,
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(res => res.dates), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)([])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._festivities$.next(r))).subscribe();
  }
  _setNations() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('nations'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(res => ({
      ...res,
      domain: res?.domain.sort((a, b) => {
        if (a.description < b.description) return -1;
        if (a.description > b.description) return 1;
        return 0;
      }).map(nation => {
        nation.extraUE = !nation.sepa || !!~SEPA_NATIONS_EXTRA_UE.indexOf(nation.code);
        return nation;
      })
    })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.shareReplay)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)({})), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._nations$.next(r))).subscribe();
  }
  _setISONations() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('ISONations'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)([])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._ISONations$.next(r))).subscribe();
  }
  _setRegions() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('regions'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(res => ({
      ...res,
      domain: res?.domain.sort((a, b) => {
    ...
    })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)([])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._regions$.next(r))).subscribe();
  }
  _setProvinces() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('provinces'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)([])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._provinces$.next(r))).subscribe();
  }
  _setCurrencies() {
    this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('currencies'), {}, {
      expiresIn: 24 * 60 * 60000
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(res => ({
      ...res,
      domain: res?.domain.sort((a, b) => {
    ...
    })), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(_ => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)([])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_8__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.tap)(r => this._currencies$.next(r))).subscribe();
  }
  getTowns(provinceCode) {
    const pathParameters = new _bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.RequestPathParams({
      provinceCode
    });
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('towns'), {
      pathParameters
    }, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getZipCode(provinceCode, townName) {
    const pathParameters = new _bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.RequestPathParams({
      provinceCode,
      townName
    });
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('zipCode'), {
      pathParameters
    }, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getZipCodes(province, municipality) {
    const bodyParameters = {
      province,
      municipality
    };
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('zipCodes'), {
      bodyParameters
    }, {
      expiresIn: 24 * 60 * 60000
    });
  ...
  getContractType() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('contractType'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getFamilySituation() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('familySituation'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getHousingSituation() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('housingSituation'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getOnlinePurposes() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('onlinePurposes'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getProfessioneCode() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('professionCode'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getContinuosIncome() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('continuosIncome'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  getContinuosOutcome() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('continuosOutcome'), {}, {
      expiresIn: 24 * 60 * 60000
    });
  }
  setPersonalizedName(productId, bodyParameters) {
    if (!productId) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.throwError)({
        message: 'Si è verificato un errore nel caricamento del productId!'
      });
    }
    const pathParameters = new _bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.RequestPathParams({
      productId: productId.toString()
    });
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('personalizedName'), {
      bodyParameters,
      pathParameters
    });
  }
  setFavourite(productId) {
    ...
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.POST, resolveUrl('favourite'), {
      pathParameters
    });
  }
  getValidPaymentDate(startingDate = new Date(), hourTimeLimit = 15) {
    // Create moment from startingDate with original utc offset.
    const startingDateMoment = moment_moment__WEBPACK_IMPORTED_MODULE_2__(startingDate);
    // Calculate Italian utc offset and saving the original one.
    const italyUtcOffset = moment_moment__WEBPACK_IMPORTED_MODULE_2__().locale('it').isDST() ? 120 : 60;
    const startingDateUtcOffset = startingDateMoment.utcOffset();
    // Set Italian utc offset.
    startingDateMoment.utcOffset(italyUtcOffset);
    // Check validity on date using Italian utc offset.
    const dateTime = startingDateMoment.hours();
    const dateWeekDay = startingDateMoment.day();
    const festivities = this._festivities$.getValue();
    if (dateTime >= hourTimeLimit || !!~[0, 6].indexOf(dateWeekDay) || !!~(festivities || []).indexOf(startingDateMoment.format('YYYY-MM-DD'))) {
      startingDateMoment.hours(0).add(1, 'day');
      return this.getValidPaymentDate(startingDateMoment.toDate()); //NB: Date object always use client timezone.
    }

    startingDateMoment.hours(0); // Optional - It can be removed.
    // Set original offset while keeping Italian time as value
    // es: 2023-01-17T00:00:00+01:00 -> 2023-01-17T00:00:00-08:00.
    startingDateMoment.utcOffset(startingDateUtcOffset, true);
    return startingDateMoment.toDate(); //NB: Date object always use client timezone.
  }

  getRemoteDate(amount, unit = 'days', startingDate = new Date()) {
    let momDate = moment_moment__WEBPACK_IMPORTED_MODULE_2__(startingDate);
    momDate.add(amount, unit);
    return momDate.toDate();
  }
  getPastQuarterStartDate(date = new Date(), steps = 0) {
    let momDate = moment_moment__WEBPACK_IMPORTED_MODULE_2__(date);
    momDate.subtract(steps, 'quarters');
    momDate.startOf('quarter');
    return momDate.toDate();
  }
  getDocTypes() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('docTypes'));
  }
  getAuthorities(docType) {
    if (!docType) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.throwError)({
        message: 'Non è stato specificato alcun tipo di documento!'
      });
    }
    const pathParameters = new _bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.RequestPathParams({
      docType
    });
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('authorities'), {
      pathParameters
    });
  }
  getAuthoritiesV2(docType) {
    if (!docType) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.throwError)({
        message: 'Non è stato specificato alcun tipo di documento!'
      });
    ...
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('authoritiesV2'), {
      pathParameters
    });
  }
  getBlockCardReasons() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('blockCardReasons'));
  }
  getFerialDay(date, days = 0, copy = false) {
    copy && (date = moment_moment__WEBPACK_IMPORTED_MODULE_2__(date));
    const isAdd = days >= 0;
    const skipFestivities = () => {
      let stringDate = date.format('YYYY-MM-DD');
      while (this._festivities$.getValue()?.includes(stringDate) || [0, 6].includes(date.day())) {
        isAdd ? date.add(1, 'day') : date.subtract(1, 'day');
        stringDate = date.format('YYYY-MM-DD');
      }
    };
    skipFestivities();
    for (let day of Array(days)) {
      isAdd ? date.add(1, 'day') : date.subtract(1, 'day');
      skipFestivities();
    }
    return date;
  ...
  getOFSSearchPeriod() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('searchPeriod'));
  }
  proposalsNumber() {
    return this._httpHandler.retrieveData(_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HTTP_METHODS.GET, resolveUrl('proposalsNumber'));
  }
  getProvinceValidator() {
    let provinceList = this._provinces$.value.domain;
    return control => {
      let found = provinceList.find(elem => {
        return elem.code === control.value;
      });
      if (found !== undefined) {
        return null;
      } else {
...
UtilitiesService.ɵfac = function UtilitiesService_Factory(t) {
  return new (t || UtilitiesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_bper_npm_core_http_handler__WEBPACK_IMPORTED_MODULE_1__.HttpHandlerService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"]('API_ENDPOINT'), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"]('EXTERNAL_URLS'));
};
UtilitiesService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: UtilitiesService,
  factory: UtilitiesService.ɵfac
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UtilitiesService, [{
...
//# sourceMappingURL=node_modules_bper_npm-core_fesm2020_bper-npm-core-utilities-domains_mjs-_268a0.js.map